...
export default function Tipps() {
    ...
    return (
        <><div className='tipContainer'>
            ...
            <Box sx={{ flexGrow: 1 }} >
                <Grid
                    container rowSpacing={1} spacing={2} columns={16}>
                    <Grid item xs={8} >
                        <Item style={{ display: "flex" }}>
                            <RestaurantMenuSharpIcon sx={{ fontSize: "18px" }} style={{ margin: "1% 2%" }} />
                    ...
                    <Grid item xs={16}>
                        <Item style={{ display: "flex" }}>
                            <RestaurantMenuSharpIcon sx={{ fontSize: "18px" }} style={{ margin: "0 1% 0 1%" }} />
